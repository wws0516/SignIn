...
<input type="hidden" name="id">
        ...
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input name="name" value="${param.user}"></input>
                </td>
            </tr>
            <tr>
                <td class="label">请假时间:</td>
                <td>
                    <input type="date" name="signtime" value="${param.signtime}"></input>
                </td>
            </tr>
            <tr>
                <td class="label">请假原因:</td>
                <td>
                    <input type="text" name="reason" cols="50" rows="8" required="required" value="${param.reason}"></input>
                </td>
            </tr>
